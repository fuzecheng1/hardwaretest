...
//        cancelBondProcess(btClass, device);
    ...
    public void conncet(BluetoothA2dp mBluetoothA2dp, BluetoothDevice mBluetoothDevice) {
        Method connect = null;
        try {
            connect = mBluetoothA2dp.getClass().getDeclaredMethod("connect", BluetoothDevice.class);
